...
public class Boa extends Animal implements ICarnivoro,IReproducible,IMuerto{
    public Boa (String name, int pX, int pY){
        super.setName(name);
    ...
    public void reproduce() {
        ...
        int posibilidad = randomNum.nextInt(7);
    ...
    public void creandoBoasBebes() {
        Animal boitaCreada = nombrePosicionBoas();
        Mapa.matrizCambios[boitaCreada.getPosicionX()][boitaCreada.getPosicionY()] = boitaCreada.getName();
        Mapa.matrizNueva[boitaCreada.getPosicionX()][boitaCreada.getPosicionY()] = boitaCreada;

        System.out.println("Ha nacido una nueva boa: " + boitaCreada.getName());
    }
    public Animal nombrePosicionBoas(){
        Random randomX = new Random();
        Random randomY = new Random();
        int posicionX = randomX.nextInt(CreadorObjetos.a);
        int posicionY = randomY.nextInt(CreadorObjetos.b);
        Animal boita = new Boa("\uD83D\uDC0D", posicionX, posicionY);
        if(Mapa.matrizCambios[posicionX][posicionY] == null){

            Mapa.matrizCambios[posicionX][posicionY]=boita;
        }else{
            boita = nombrePosicionBoas();
        }
        return boita;
    }
    @Override
    public void muerto(Animal animal) {
        //System.out.println("La boa: " + super.getName() + " fue deborado :(");
