...
public class Ciervo extends Animal implements IHerviboro, IMuerto, IReproducible{
    public Ciervo (String name, int pX, int pY){
        super.setName(name);
    ...
    public void muerto(Animal animal) {
        //System.out.println("El ciervo: " + super.getName() + " fue deborado :(");
    ...
    public void comerPlantas(int posX, int posY) {
        if(Mapa.matrizNueva[posX][posY] instanceof Planta){
            ...
            System.out.println("El ciervo: " + this.getName() + " está comiendo: " + laPlanta.getName());
    ...
    public void creandoCiervosBebes() {
        Animal ciervitoCreado = nombrePosicionCiervos();
        Mapa.matrizCambios[ciervitoCreado.getPosicionX()][ciervitoCreado.getPosicionY()] = ciervitoCreado.getName();
        Mapa.matrizNueva[ciervitoCreado.getPosicionX()][ciervitoCreado.getPosicionY()] = ciervitoCreado;

        System.out.println("Ha nacido un nuevo ciervo: " + ciervitoCreado.getName());
    }
    public Animal nombrePosicionCiervos(){
        Random randomX = new Random();
        Random randomY = new Random();
        int posicionX = randomX.nextInt(CreadorObjetos.a);
        int posicionY = randomY.nextInt(CreadorObjetos.b);
        Animal ciervito = new Ciervo("\uD83E\uDD8C", posicionX, posicionY);
        if(Mapa.matrizCambios[posicionX][posicionY] == null){

            Mapa.matrizCambios[posicionX][posicionY]=ciervito;
        }else{
            ciervito = nombrePosicionCiervos();
        }
        return ciervito;
    }
}
