...
public class Jabali extends Animal implements IHerviboro, IMuerto, IReproducible{
    public Jabali (String name, int pX, int pY){
        super.setName(name);
    ...
    public void muerto(Animal animal) {
        //System.out.println("El jabali: " + super.getName() + " fue deborado :(");
    ...
    public void comerPlantas(int posX, int posY) {
        if(Mapa.matrizNueva[posX][posY] instanceof Planta){
            ...
            System.out.println("El jabalí: " + this.getName() + " está comiendo: " + laPlanta.getName());
    ...
    public void reproduce() {
        ...
        int posibilidad = randomNum.nextInt(9);
    ...
    public void creandoJabalisBebes() {
        Animal jabaliCreado = nombrePosicionJabalis();
        Mapa.matrizCambios[jabaliCreado.getPosicionX()][jabaliCreado.getPosicionY()] = jabaliCreado.getName();
        Mapa.matrizNueva[jabaliCreado.getPosicionX()][jabaliCreado.getPosicionY()] = jabaliCreado;

        System.out.println("Ha nacido una nuevo jabali: " + jabaliCreado.getName());
    }
    public Animal nombrePosicionJabalis(){
        Random randomX = new Random();
        Random randomY = new Random();
        int posicionX = randomX.nextInt(CreadorObjetos.a);
        int posicionY = randomY.nextInt(CreadorObjetos.b);
        Animal jabalito = new Jabali("\uD83D\uDC17", posicionX, posicionY);
        if(Mapa.matrizCambios[posicionX][posicionY] == null){

            Mapa.matrizCambios[posicionX][posicionY]=jabalito;
        }else{
            jabalito = nombrePosicionJabalis();
        }
        return jabalito;
    }
}
